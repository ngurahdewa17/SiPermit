...
<div class="content-wrapper"  style="background:white">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Data Rejected</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 shadow rounded">
                            <div class="card-body">
                                ...
                                <form action="/editRejected/{{$editVerifikasi->sistemPengajuan->id}}/cek" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    @method('put')
                                    <input type="hidden" value="{{$editVerifikasi->id}}" name="idDataVerifikasi" >   
                                    <div class="form-group">
                                        <label class="font-weight-bold">Nama Pemohon</label>
                                        <input type="text" class="form-control @error('namaMitra') is-invalid @enderror" name="namaMitra"  placeholder="Masukkan nama mitra" required value="{{$editVerifikasi->sistemPengajuan->namaMitra}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" name="email"  placeholder="Masukkan email anda" required value="{{$editVerifikasi->sistemPengajuan->email}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('namaPerusahaan') is-invalid @enderror" name="namaPerusahaan"  placeholder="Masukkan nama perusahaan anda" required value="{{$editVerifikasi->sistemPengajuan->namaPerusahaan}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror" name="pekerjaan"  placeholder="Masukka nama pekerjaan" required value="{{$editVerifikasi->sistemPengajuan->pekerjaan}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('noSP2KPA') is-invalid @enderror" name="noSP2KPA"  placeholder="Masukkan No.SP2KPA" required value="{{$editVerifikasi->sistemPengajuan->noSP2KPA}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="Tanggal" name="haritanggalMulai" class="form-control @error('haritanggalMulai') is-invalid @enderror"  placeholder="Masukkan Tanggal Mulai Pekerjaan" required value="{{$editVerifikasi->sistemPengajuan->haritanggalMulai}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="Tanggal" name="haritanggalSelesai" class="form-control @error('haritanggalSelesai') is-invalid @enderror"  placeholder="Masukkan Tanggal Selesai Pekerjaan" required value="{{$editVerifikasi->sistemPengajuan->haritanggalSelesai}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('namaLokasi') is-invalid @enderror" name="namaLokasi"  placeholder="Masukkan Nama Lokasi" required value="{{$editVerifikasi->sistemPengajuan->namaLokasi}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('pengawasPekerjaan') is-invalid @enderror" name="pengawasPekerjaan"  placeholder="Masukkan nama pengawas pekerjaan" required value="{{$editVerifikasi->sistemPengajuan->pengawasPekerjaan}}">
                                    
                                        <!-- error message untuk title -->
                                        @error('pengawasPekerjaan')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('noHPPegawaiPekerjaan') is-invalid @enderror" name="noHPPegawaiPekerjaan"  placeholder="Masukka no HP pengawas pekerjaan" required value="{{$editVerifikasi->sistemPengajuan->noHPPegawaiPekerjaan}}">
                                    
                                        <!-- error message untuk title -->
                                        @error('noHPPegawaiPekerjaan')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('pengawasK3') is-invalid @enderror" name="pengawasK3"  placeholder="Masukka nama pengawas K3" required value="{{$editVerifikasi->sistemPengajuan->pengawasK3}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('noHPPegawaiK3') is-invalid @enderror" name="noHPPegawaiK3"  placeholder="Masukka no HP pengawas K3" required value="{{$editVerifikasi->sistemPengajuan->noHPPegawaiK3}}">
                                    ...
                                    <button type="submit" class="btn btn-md btn-success">UPDATE REJECTED</button>
