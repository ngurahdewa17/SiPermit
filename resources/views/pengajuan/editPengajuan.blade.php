                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card border-0 shadow rounded">
                            <div class="card-body">
                                <form action="/store_editPengajuan/{{$editPengajuan->id}}/store" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    @method('put')
                                   
                                    <div class="form-group">
                                        <label class="font-weight-bold">Nama Pemohon</label>
                                        <input type="text" class="form-control @error('namaMitra') is-invalid @enderror" name="namaMitra"  placeholder="Masukkan nama mitra" required value="{{$editPengajuan->namaMitra}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" name="email"  placeholder="Masukkan email anda" required value="{{$editPengajuan->email}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('namaPerusahaan') is-invalid @enderror" name="namaPerusahaan"  placeholder="Masukkan nama perusahaan anda" required value="{{$editPengajuan->namaPerusahaan}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror" name="pekerjaan"  placeholder="Masukka nama pekerjaan" required value="{{$editPengajuan->pekerjaan}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('noSP2KPA') is-invalid @enderror" name="noSP2KPA"  placeholder="Masukkan No.SP2KPA" required value="{{$editPengajuan->noSP2KPA}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="Tanggal" name="haritanggalMulai" class="form-control @error('haritanggalMulai') is-invalid @enderror"  placeholder="Masukkan Tanggal Mulai Pekerjaan" required value="{{$editPengajuan->haritanggalMulai}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="Tanggal" name="haritanggalSelesai" class="form-control @error('haritanggalSelesai') is-invalid @enderror"  placeholder="Masukkan Tanggal Selesai Pekerjaan" required value="{{$editPengajuan->haritanggalSelesai}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('namaLokasi') is-invalid @enderror" name="namaLokasi"  placeholder="Masukkan Nama Lokasi" required value="{{$editPengajuan->namaLokasi}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('pengawasPekerjaan') is-invalid @enderror" name="pengawasPekerjaan"  placeholder="Masukkan nama pengawas pekerjaan" required value="{{$editPengajuan->pengawasPekerjaan}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('noHPPegawaiPekerjaan') is-invalid @enderror" name="noHPPegawaiPekerjaan"  placeholder="Masukka no HP pengawas pekerjaan" required value="{{$editPengajuan->noHPPegawaiPekerjaan}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('pengawasK3') is-invalid @enderror" name="pengawasK3"  placeholder="Masukka nama pengawas K3" required value="{{$editPengajuan->pengawasK3}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('noHPPegawaiK3') is-invalid @enderror" name="noHPPegawaiK3"  placeholder="Masukka no HP pengawas K3" required value="{{$editPengajuan->noHPPegawaiK3}}">
                                    ...
                                    <a href="/tampil_pengajuan" class="btn btn-warning">KEMBALI</a>
                                </form> 
