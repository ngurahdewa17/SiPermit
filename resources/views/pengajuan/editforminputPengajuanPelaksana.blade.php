  ...
  <div class="content-wrapper" style="background: white">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Form Edit Pelaksana</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card border-0 shadow rounded">
                            <div class="card-body">
                                <form action="/formeditPelaksana/{{$id}}/store" method="POST" >
...
<script type="text/javascript">
    ...
    {
        ++i;
        $("#dynamicAddRemove").append('<tr><td><input type="text" name="moreFields['+i+'][namaPelaksana]" placeholder="Masukan nama pelaksana" class="form-control" /></td><td><input type="text" name="moreFields['+i+'][noTlp]" placeholder="Masukan no tlp/HP pelaksana" class="form-control" /></td><input type="hidden" name="moreFields['+i+'][idDataPengajuan]" value='+a+' /><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>');
    });
