        ...
        <div class="book">
                        ...
                        <div class="card ">
                            ...
                            <table class="" width="100%">
                                ...
                                <tr class="">
                                    ...
                                    <td width="500"><b> : {{ $pekerjaan }}</b></td>
                                </tr>
                                <tr class="">
                                    <td width="150" ><b>Lokasi kerja</b></td>
                                    <td width="500"><b> : {{ $namaLokasi }}</b></td>
                                </tr>
                                <tr class="">
                                    <td width="150"><b>Tanggal Pekerjaan</b></td>
                                    <td width="500"><b> : {{ $haritanggalMulai }}</b></td>
                                </tr>
                                <tr class="">
                                    <td width="150"><b>Mitra Pelaksana</b></td>
                                    <td width="500"><b> : {{ $namaMitra }}</b></td>
                                </tr>
                            </table>
                            <br>
                        </div>
            ...
            <div class="page">
                ...
                <div class="subcard">
                    <table class="" width="100%" rules="rows" >
                        <tr class="">
                            ...
                            <th colspan="2">{{ $noSP2KPA }}</th>
                        </tr> 
                        <tr class="">
                            <th colspan="2" align="left">Berlaku : </th>
                            <th colspan="3">{{ $haritanggalSelesai }}</th> 
                        </tr>
                        <tr class="">
                ...
                <div class="kontent ">
                    <table class=" " width="100%" >
                        <tr class="">
                            ...
                            <th width="10"> : </th>
                            <th align="left"> {{ $namaPerusahaan }}</th>
                        </tr> 
                        <tr class="">
                        ...
                        <tr class="">
                            ...
                            <th width="10"> : </th>
                            <th align="left">{{ $namaMitra }}</th>   
                        </tr>
                        <tr class="">
                            <th width="180" align="left">No.Pemohon</th>
                            <th width="10"> : </th>
                            <th align="left">{{ $noHPPegawaiPekerjaan }}</th>   
                        </tr>                            
                    </table> 
                </div>
                <div class="kontent">
                    ...
                    <table class=" " width="100%" rules="rows" >
                        <tr class="">
                            ...
                            <th align="left"> <h5>{{ $pekerjaan }}</h5></th>
                        </tr> 
                        <tr class="">
                            <th width="180" align="left"><h5>no.SP2K/PA</h5></th>
                            <th width="10"><h5> : </h5></th>
                            <th align="left"><h5> {{ $noSP2KPA }} </h5></th> 
                        </tr>
                        <tr class="">
                            <th width="180" align="left"><h5>Hari/Tanggal Mulai</h5></th>
                            <th width="10"><h5> : </h5></th>
                            <th align="left"><h5>{{ $haritanggalMulai }}</h5></th>   
                        ...
                        <tr class="">
                            ...
                            <th width="10"><h5> : </h5></th>
                            <th align="left"><h5>{{ $haritanggalSelesai }}</h5></th> 
                ...
                <div class="kontent ">
                    ...
                    <table class=" bordert1" width="100%" rules="all">
                        <tr class="">
                            ...
                            <th width="10"><h5> :</h5> </th>
                            <th align="left"> <h5>{{ $namaLokasi }}</h5></th>
                        </tr> 
                        <tr class="">
                            <th width="180" align="left"><h5>Aktifitas</h5></th>
                            <th width="10"><h5> : </h5></th>
                            <th align="left"><h5> {{ $aktifitas }} </h5></th> 
                ...
                <div class="kontent ">
                    ...
                    <table class=" bordert1" width="100%" >
                        <tr class="">
                            ...
                            <th width="10"><h5> :</h5> </th>
                            <th align="left"> <h5>{{ $taskList }}</h5></th>
                        </tr> 
                        <tr class="">
                    ...
                    <table class=" bordert1" width="100%" rules="all" >
                        ...
                        <tbody>
                            <tr class=" center">
                                ...
                                <td rowspan="3">{{ $pengawasPekerjaan }}</td>
                        ...
                        <tbody>   
                            <tr class="center">
                                ...
                                <td rowspan="3">{{ $pengawasK3 }}</td>                            
                                <td rowspan="3">Team Leader</td>
                                <td rowspan="3">{{ $noHPPegawaiK3 }}</td>
                            </tr>                    
                        </tbody>
                    </table> 
                </div>
                ...
                <div class="kontent " >
                    ...
                    <table class=" " width="100%" style="margin-left:70px"; >
                        <tr class="">
            ...
            <div class="page">
                ...
                <div class="subcard">
                    <table class="" width="100%" rules="rows" >
                        <tr class="">
                            <th rowspan="3" width="50%" ><h4>FORMULIR IJIN KERJA EKSTERNAL</h4></th>
                            <th colspan="2" align="left">{{ $noSP2KPA }} :</th>
                ...
                <div class="kontent ">
                    <table class="  center" width="100%" >
                        ...
                        <tbody>
                            <tr class="">
                                <td rowspan="3"><b>{{$pengawasPekerjaan}}</b></td>
                                <td rowspan="3"><b>Hiltanto Sidik Sudrajat</b></td>
                            </tr>         
                        </tbody>
                        <tbody>
                            <tr class="">
                ...
                <div class="kontent ">
                    <table class=" bordert1" width="100%" rules="all" >
                        ...
                        <tr class="">
                            ...
                            <th width="10"> : </th>
                            <th align="left"> {{ $haritanggalMulai }} </th> 
                        </tr>
                        <tr class="">
                            <th width="180" align="left">Lokasi Pekerjaan</th>
                            <th width="10"> : </th>
                            <th align="left">{{ $namaLokasi }}</th>   
                        </tr>      
                    </table> 
                </div>
                <br>
